...
EC2NodeClass name
*/}}
{{- define "karpenter-resources.ec2NodeClassName" -}}
{{- default .Values.ec2NodeClass.name | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
NodePool name
*/}}
{{- define "karpenter-resources.nodePoolName" -}}
{{- default .Values.nodePool.name | trunc 63 | trimSuffix "-" }}
{{- end }}
